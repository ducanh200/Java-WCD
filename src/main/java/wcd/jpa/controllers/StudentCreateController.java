...
public class StudentCreateController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("form/create_student.jsp").forward(req,resp);
    }
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try(Session session = sessionFactory.openSession()) {
            ...
            String senderEmail = "anguyenduc075@gmail.com";
            String passwordEmail = "ekhpmtonjpkgajdk";
            ...
            try{
                ...
                message.addRecipient(Message.RecipientType.TO,new InternetAddress("anguyenduc075@gmail.com"));
                String content = "<h1>This is a test email !</h1>";
        ...
        resp.sendRedirect("list_student");
    }
}
